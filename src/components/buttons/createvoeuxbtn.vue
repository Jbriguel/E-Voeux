...
.buttonCreateVoeux:hover {
  background: #a61715;
  text-shadow: 0 1px 2px rgba(0, 0, 0, 0.75), 0 0 40px #fff;
  box-shadow: inset 1px 1px 0px rgba(255, 255, 255, 0.25),
    /* highlight */ inset 0 0 6px #cc1943,
    /* inner glow */ inset 0 80px 80px -40px #cc1943,
    /* gradient */ 1px 1px 3px rgba(0, 0, 0, 0.75); /* shadow */
}
.buttonCreateVoeux:focus {
  outline: none; /*FF*/
}
.buttonCreateVoeux:active {
  box-shadow: inset 1px 1px 0px rgba(255, 255, 255, 0.25),
