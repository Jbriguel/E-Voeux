<template> 
  <section class="flex justify-center items-center bg-gray-100 text-black">
      ...
      <center class="mt-24 m-auto">
        ...
        <div class="tracking-widest mt-4">
          ...
          <span class="text-gray-500 text-xl"
            >Désolé, nous n'avons pas trouvé ce que vous cherchez !</span
          >
        </div>
      </center>
      <center class="mt-6">
        <a
          ...
          href="/"
          class="px-8 py-3 font-semibold rounded bg-orange-400 "
          >Page d'Accueil</a
        >
      </center>
    </div>
